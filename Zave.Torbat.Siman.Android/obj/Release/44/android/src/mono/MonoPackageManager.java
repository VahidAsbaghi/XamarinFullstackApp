...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Zave.Torbat.Siman.Android.dll" comes first in this list. */
		"Zave.Torbat.Siman.Android.dll",
		...
		"Zave.Torbat.Siman.Co.Core.dll",
		"Zave.Torbat.Siman.Co.Presentation.dll",
	};
